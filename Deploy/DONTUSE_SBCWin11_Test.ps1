...
Copy-Item X:\OSDCloud\Config\Scripts\AES.key C:\OSDCloud\Scripts -Force -Verbose
Copy-Item X:\OSDCloud\Config\Scripts\pass.txt C:\OSDCloud\Scripts -Force -Verbose
